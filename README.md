...
- 🛠️ **Crafting small CLIs & automation** — tools that scratch my own itch
- 🧪 **Exploring full-stack** — going wider, one project at a time
- 📚 **Learning in public** — turning private experiments into things worth sharing
...
I build tools to solve my own problems first, then clean them up for everyone else. Working solo, moving at my own pace, letting curiosity pick the next thing.
